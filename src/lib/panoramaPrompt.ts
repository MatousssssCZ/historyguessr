// Master prompt pro generování 360° panoramatu (klientská verze pro uložení
// k události). Drží se stejné šablony jako api/generate-panorama.ts.

export type PanoramaPromptParams = {
  title: string
  date?: string
  period?: string
  location?: string
...
export function buildPanoramaPrompt(p: PanoramaPromptParams): string {
